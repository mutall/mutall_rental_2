...
<body>
    <div class="container mt-4">
        <div class="form-group row">
            <div class="col-md-3">
                <label for="Adjustment"> Adjusted for:</label>
                <input
                    type="text"
                    name="description"
                    onchange= "pr.page_change_field(this)"
                    value="<?php echo $pr->page_field_value('description'); ?>"
                    />
            </div>
            <div class="col-md-3">
    ...
    <article class="container mt-3">
        <div>
            ...
            <tbody>
                <?php
        $results = $adjustments->get_adjustment();
        while ($result = $results->fetch_assoc()) {
                  ?>
                    <tr class="content" primarykey="<?php echo $result['adjustment']; ?>">
