...
//
//legal authority.
$lawyer = "Lawrence Karanja<br> Advocate<br>
            2nd Floor, Co-op Bank House<br>
            Haile Selassie Avenue <br>
            PO Box 48231--00100<br>
            Nairobi, Kenya
            ";
?>
<html>
    ...
    <body >
        <header id="header" class="">
            <button id="myBtn" onclick="toggleNav()">SHOW NAVIGATION</button>
        </header><!-- /header -->
        <aside class="nav" id="myNav">
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>

            <a href="#s1">1.Rights of Tenant</a>
            <a href="#s2">2.Obligation of the Tenants</a>
            <a href="#s3">3.Additional Obligation of the Tenants</a>
            <a href="#s4">4. Obligations of the Landlord</a>
            ...
            <a href="#s8">8.Tenant Renewal Terms</a>
            <a href="#s9">9.Conditions of either Tenant and Landlord</a>
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                        <no>1. The Rights of the tenants</no>
                        <content>
                            <agreement>
                                <p>DATED <data><?php echo $date; ?></data></p>
                                <p><data><b><?php echo $landlord; ?></b></data></p>
                                <p>TO</P>
                                ...
                                <p><b>Drawn by:</b> 
                                    <data><br><?php echo $lawyer; ?></data></p>
                            </agreement>

                            <b>IN THE MATTER OF THE LAND ACT NO.6 OF 2012<br>
                            IN THE MATTER OF THE LAND REGISTRATION ACT NO.3 OF 2012<br>
                            IN THE MATTER OF THE REGISTERED LAND ACT (CHAPTER 300) (NOW REPEALED)<br></b>
                            <p>LEASE<br>
                            <p>THIS LEASE is made the  day of  Two Thousand and<br></p>
                            BETWEEN
                            <p><data> 1. <b><?php echo $landlord; ?></b></data> whose address for purposes hereof is care of Post Office Box Number 374-00206 Kiserian, in the Republic of Kenya (hereinafter called the Landlord" which expression shall where the context so admits include its successors and assigns} of the one pair;</p>
                            <br>AND
                            <p><data> 2. <b><?php echo $client_title; ?></b></data> a body corporate duly established under the
                            ...
                            <b>WHEREAS:-</b>
                            <p>
                            A) The Landlord is registered as the proprietor of ALL THAT piece of land TITLE NO. <data><?php echo $title; ?></data> together with all buildings and improvements erected and being thereon (hereinafter called the “land").</p>
                            <p>
                            B) The Landlord has  erected a building on the said piece or parcel of land (hereinafter called "the Building") which comprises inter alia offices, shops and the usual conveniences;</p>
                            <p>
                            C) The Landlord has agreed to grant a Lease of the premises forming a portion of the building more particularly descnbed in the First Schedule hereto (“hereinafter called "the Demised Premises!to the Tenant under the terms and conditions hereinafter mentioned.</p
                            
                            <br><b>NOW THIS LEASE WITNESSETH</b> that
                            <p>
                            1. IN CONSIDERATION of the rent hereinafter reserved and of the covenants and agreements by the Tenant hereinafter contained the Landlord DOES HEREBY LEASE unto the Tenant ALL THAT the Demised Premises TOGETHER WITH the night to the Tenant and all persons authorised by the Tenant in common with the Landlord and the other tenants and occupiers (if any) of the Building and all persons duly authorised   by them (not otherwise lessees  to  use  the entrance halls and staircases, landings,  passages for the purposes only of ingress to and egress from the Building during the business hours hereinafter defined or as may from time to time be determined by the Landlord <b>PROVIDED THAT</b> if the Tenant shall give to the landlord  or  its  agent  reasonable notice  of   such  Tenants  desire  the Landlord  will  endeavor  to make suitable arrangements for the Tenant  and members of  the Tenant' s staff   to  obtain  access  to  the Demised Premises at such other times as the Tenant may require <b>AND TOGETHER ALSO</b> with the like right to use the lavatories and washing conveniences (not otherwise leased) in the Building as the same may be allocated by the Landlord <b>AND TOGETHER ALSO</b> in common with all other persons  entitled thereto and so far only as the Landlord has power to grant the same, with the free passage and  running of water,soil and electricity from and to the Demised Premises through the drams, pipes,wires, cables and meters in  or under the adjoining or adjacent property <b>BUT EXCEPTING AND RESERVING</b> unto the Landlord and the person or persons for the time being occupying any other part or parts of the Building the free passage and running of the water, soil and electricity from the adjoining or adjacent property through the drains, pipes, wires, cables and meters in or under the Demised Premises and the right of the Landlord to enter the Demised Premises at all reasonable times by prior appointment for the purpose of inspection, altering, adding to or repairing the same <b>TO BE HELD</b> by the Tenant as lessee for a Term more particularly  described  in  the  Second  Schedule  (hereinafter called “the Term) <b>SUBJECT</b> nevertheless to determination as hereinafter provided <b>YIELDING AND</b> therefor end thereout  during theTerm the rent in the amount and in the manner Third Schedule.
                        </content>
            </section>
            <section id="s2">
                <no>2. Obligation of the tenants.</no>
                <content>
                    <div>
                        <p>
                          The Tenant to the intent that the obligations set out may continue throughout the continuance of the Term hereby created covenants and agrees with the Landlord as follows:-
                      </div>
                    ...
                    <div id="s2_1">
                        ...
                        <article>To pay the rent hereby reserved at the times and in the manner aforesaid clear of all deductions whatsoever;
                        </article>
                    </div>
                    <div id="s2_1">
                        <span>
                        ...
                        <article>To pay and indemnify the Landlord against Value Added Tax or any tax of a similar nature which
                    ...
                    <div id="s2_3">
                        ...
                        <article>To deposit with the Landlord forthwith the sum more particularly described in the Fourth Schedule being the equivalent of three months gross rent as a security deposit which sum shall be held by the Landlord to the credit of the Tenant's account and applied as hereinafter provided.
                        </article>
                    </div>
                    <div id="s2_4">
                        <span>
                        ...
                        <article>To pay all charges in respect of electricity and telephones installed in the Demished Premises as the same become due.
                        </article>
                    </div>
                    <div id="s2_5">
                        <span>
                            2.5 Biders(suppliers).
                        </span>
                        <article>In the event of water being supplied separately to the Demised Premises to pay to the Landlord the cost of supplying and installing a meter AND to pay for all water so supplied to the   Demised
                    ...
                    <div id="s2_12">
                        <span>
                            2.12 Permission for Inspection.
                        </span>
                        <article>To permit any agent employed by the Landlord or the Landlord to enter the Demised Premises for purposes of inspecting the same and in the ordinary course of his duty in the company of a member of the Tenant's staff (excepting only in Ihe case of emergency ).
                        </article>
                    </div>
                    <div id="s2_13">
                        <span>
                            2.13 Examining Premise Condition.
                        </span>
                        <article>
                    ...
                    <div id="s2_15">
                        <span>
                            2.15 Making by the Consent of the Landlord.
                        </span>
                        <article>
                            Not to make without the previous molten consent of the Landlord first had and obtained (which consent shall not be unreasonably withheld) structural alterations. partitions or structural additions in or to the Demised Premises or to the Landlords  fixtures. if the Landlord shall grant
                    ...
                    <div id="s2_24">
                        ...
                        <article>
                            Not to do nor permit not suffer to be done upon or within the Demised Premises anything which in the opinion of the Landlord may be or become a nuisance or annoyance to or in any way interfere with the quiet user of the other portions of the Building or any adjoining or neighboring premises.
                        </article>
                    </div>
                    <div id="s2_25">
                        <span>
                    ...
                    <div id="s2_26">
                        <span>
                            2.26 Tenant Observation.
                        </span>
                        <article>
                            To perform and observe so for as the same are capable of being performed and observed by the tenant all covenants, agreement and conditions, restrictions stipulations and provisions affecting the Demised Premises and under which the piece of land upon which the Building is erected is held.
                        </article>
                    </div>
                    <div id="s2_27">
                        <span>
                    ...
                    <div id="s2_33">
                        ...
                        <article>
                            ...
                            <li>
                                ...
                                necessary for the protection of the exterior of the Building.</list>
            ...
            <section id="s3">
                <no>3. Additional obligation of the tenants.</no>
                <content>
                    <p>
                    <div>
                    ...
                    <div>
                        ...
                        <article>
                            Will not use the Demised Premises or any part thereof in such a way as to render the same subject to the provisions of the Factories Act (Chapter 514) or any statutory amendment or re-enactment thereof.
                        </article>
                    </div>
                    <div>
                        <span>
                    ...
                    <div>
                        ...
                        <article>
                            Will not make any alterations or additions to the electrical equipment or appliance installed in the Demised Premises whether by the Landlord or by the Tenant 'without the prior consent of the Landlord in each instance, such consent not to be unreasonably withheld.
                        </article>
                    </div>
                    <div>
                        <span>
                            3.5 Notifying the Landlord Incase of Danger
                        </span> 
                        <article>
                            Will give immediate notice to the Landlord in case of fire or accidents or any event that may lead to such fire and accident in the Demised 3remises or o the Building or of defects therein or in any fixtures or equipment therein.
                        </article>
                    </div>
                    <div>
                        <span>
                        ...
                        <article>
                            Will if the Demised Premises shall be or become infested with vermin, at the Tenant' s own expense cause the same to be exterminated from t me to time to the satisfaction of the Landlord AND WILL employ such exterminators as shall be approved by the Landlord,
                        </article>
                    </div>
                    </p>
                </content>
            ...
            <section id="s4">
                <no>4. Obligations of the landlord.</no>
                <content>
                    <p>
                    <div>
                    ...
                    <div>
                        ...
                        <article>
                            To repair and keep the main structure of the building and external areas including the roof in good
                    ...
                    <div>
                        ...
                        <article>
                            To pay all rates, taxes, rent to Government (if any ),  dues and other outgoings that are payable in
                    ...
                    <div>
                        ...
                        <article>
                            To procure the payment of the head rent and the Site Value Tax in respect of the Building to the
                    ...
                    <div>
                        ...
                        <article>
                            To procure the employment/maintenance of and such staff as may be necessary for the security of the Building and the Demised Premises and the carrying out of the obligations on the part of the Landlord referred to in sub-clause (a) of this clause
                        </article>
                    </div>
                    <div>
                        <span>
            ...
            <section id="s5">
                ...
                <content>
                    ...
                    <div>
                        ...
                        <article>
                            This lease is subject and subordinate to ail ground or underlying leases and to any charges which may now or hereafter affect such leases or the Demised Premises of which the Demised Premises form part and to all renewals, modifications, consolidation, replacements and extensions thereof;
                        </article>
                    </div>
                    <div>
                        <span>
                    ...
                    <div>
                        ...
                        <article>
                            No provision contained in this lease shall be waived or varied by either party hereto except by agreement in writing which agreement shall if the case so requires be duly registered in the relevant Lands Registry ;
                        </article>
                    </div>
                    <div>
                        <span>
                        ...
                        <article>
                            No delay by the Landlord in exercising any of its right hereunder shall be deemed to be in any way a waiver of such rights
                        </article>
                    </div>
                </content>
            </section>
            <section id="s6">
                <no>6. Conditions of the landlord.</no>
                <content>
                    <p>
                    <div>
                        <span>
                        ...
                        <article>
                            The Landlord shall hold the deposit reserved in clause 2.1 above to the credit of the Tenant's account (without payment of interest thereon) upon the following terms and conditions:
                        </article>
                    </div>
                    <list>
                    <li>
            ...
            <section id="s9">
                <no>9. Conditions of either tenant and landlord</no>
                <content>
                    <p>
            ...
            <section id="s11">
                <no>11. THE SCHEDULES HEREINBEFOREREFERRED TO:</no>
                <content>
                    <div>
                        <p>THE FIRST SCHEDULE: THE PREMISES</p>
                        ...
                        <div/>
                        <div>
                            <p>THE FOURTH SCHEDULE: THE DEPOSIT</p>
