...
--
-- Host: localhost:3306
-- Generation Time: Mar 27, 2019 at 04:28 PM
...
(19, 32, NULL, NULL, NULL, 223620, 218700, '2019-01-01', NULL, '2019-02-01'),
...
(24, 19, NULL, NULL, NULL, NULL, 36740, NULL, NULL, '2019-03-01');
...
(1, 27, NULL, 'Wrong calculation', '2019-02-28', 424),
(2, 1, NULL, 'Overcharging of opening balances for Feb. 2019', '2019-02-28', 4105),
(3, 31, NULL, 'Payment for 2 months rent deposit', '2019-02-21', 40000),
...
(4, 31, NULL, 'Charge for garbage deposit', '2019-02-01', 300),
...
(697, 787, 10, NULL, '2019-02-19', 18317.66);
...
(1, 20, NULL, '2019-02-13', 'KCB', 20000, NULL, NULL, 'Rent payment'),
(2, 9, NULL, '2019-02-05', 'Coop', 12500, NULL, NULL, 'Rent payment'),
(3, 7, NULL, '2019-02-05', 'Coop', 20000, NULL, NULL, 'Rent payment'),
(4, 28, NULL, '2019-02-05', 'Coop', 10000, NULL, NULL, 'Rent payment'),
(5, 4, NULL, '2019-02-16', 'Coop', 36750, NULL, NULL, 'Rent payment'),
...
(85, 2019, 3, '2019-03-31'),
(86, 2019, 2, '2019-02-28'),
(87, 2019, 4, '2019-04-30');
...
(256, 5, 1537, '2019-01-31', 2000.043, NULL),
(257, 25, NULL, '2019-01-31', 109, NULL),
(258, 3, NULL, '2019-01-31', 104.344, NULL),
(259, 22, NULL, '2019-01-31', 225.277, NULL),
(260, 24, 1534, '2019-01-31', 229.499, NULL),
(261, 21, NULL, '2019-01-31', 263.293, NULL),
(262, 23, 1546, '2019-01-31', 13.317, NULL),
(263, 12, NULL, '2019-01-31', 105, NULL),
(264, 13, 1537, '2019-01-31', 119, NULL),
(265, 2, 1534, '2019-01-31', 161, NULL),
(266, 10, NULL, '2019-01-31', 1130.292, NULL),
(267, 1, 1547, '2019-01-31', 70, NULL),
(268, 4, 1554, '2019-01-31', 80.382, NULL),
(269, 8, 1536, '2019-01-31', 221.5, NULL),
(270, 20, 1536, '2019-01-31', 14, NULL),
(271, 26, 1547, '2019-01-31', 0, NULL),
(272, 27, 1534, '2019-01-31', 0, NULL),
(273, 28, NULL, '2019-01-31', 0, NULL),
(274, 29, 1537, '2019-01-31', 0, NULL),
...
(3162, 29, 1506, '2019-02-28', 7.908, NULL),
(3163, 28, NULL, '2019-02-28', 10.377, NULL),
(3164, 27, 1503, '2019-02-28', 15.371, NULL),
(3165, 26, 1516, '2019-02-28', 9.755, NULL),
(3166, 24, 1503, '2019-02-28', 261.934, NULL),
(3167, 23, 1515, '2019-02-28', 16.936, NULL),
(3168, 22, NULL, '2019-02-28', 285.371, NULL),
(3169, 21, NULL, '2019-02-28', 330.361, NULL),
(3170, 20, 1505, '2019-02-28', 14, NULL),
(3171, 10, NULL, '2019-02-28', 1162.946, NULL),
(3172, 8, 1505, '2019-02-28', 236.1, NULL),
(3173, 7, NULL, '2019-02-28', 1345.511, NULL),
(3174, 5, 1506, '2019-02-28', 2042.855, NULL),
(3175, 4, 1523, '2019-02-28', 81.389, NULL),
...
--
ALTER TABLE `charge`
  MODIFY `charge` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1178;
...
--
ALTER TABLE `closing_balance`
  MODIFY `closing_balance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=991;
...
--
ALTER TABLE `electricity`
  MODIFY `electricity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=961;
...
--
ALTER TABLE `invoice`
  MODIFY `invoice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1627;
...
--
ALTER TABLE `period`
  MODIFY `period` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `rent`
  MODIFY `rent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1903;
...
--
ALTER TABLE `water`
  MODIFY `water` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=476;
...
--
ALTER TABLE `wreading`
  MODIFY `wreading` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3450;
